...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] dark:bg-[#040404] p-6 md:p-12 font-sans selection:bg-primary/20">
      <main className="max-w-5xl mx-auto flex flex-col gap-10">
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="flex flex-col gap-2">
            <h1 className="text-5xl font-black tracking-tighter text-zinc-900 dark:text-white flex items-center gap-3">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="p-5 rounded-2xl bg-zinc-50 dark:bg-white/5 border border-zinc-100 dark:border-white/5 flex flex-col gap-3">
                ...
                <p className="text-xs text-zinc-500 dark:text-zinc-500 leading-relaxed">
                  ...
                  However, you can download your clips locally first and then use ClipTrim.
                </p>
                <a 
