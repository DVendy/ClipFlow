...
import { Alert01Icon, InformationCircleIcon, Loading03Icon, Scissor01Icon, YoutubeIcon } from "@hugeicons/core-free-icons";
      ...
      {isMobile && (
        <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-900/50 p-4 rounded-2xl flex items-start gap-3 mb-10">
          ...
          <div className="flex flex-col gap-1">
            <p className="text-sm font-bold text-amber-800 dark:text-amber-400 uppercase tracking-wider">Mobile Warning</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        <div className="lg:col-span-12 xl:col-span-7 flex flex-col gap-8">
          <div className="flex flex-col gap-4">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-black uppercase tracking-[0.2em] text-zinc-400 flex items-center gap-2">
                <span className="bg-zinc-100 dark:bg-zinc-800 size-6 rounded-full flex items-center justify-center text-sm text-zinc-500">1</span>
                Select Video
              </h3>
            ...
            <div className="p-5 rounded-2xl bg-zinc-50 dark:bg-white/5 border border-zinc-100 dark:border-white/5 flex flex-col gap-3">
              ...
              <a
                ...
                target="_blank"
                className="text-primary text-sm font-black uppercase tracking-wider hover:underline flex items-center gap-1"
              >
          ...
          {videoFile && (
            <div className="flex flex-col gap-4">
              <h3 className="text-sm font-black uppercase tracking-[0.2em] text-zinc-400 flex items-center gap-2">
                <span className="bg-zinc-100 dark:bg-zinc-800 size-6 rounded-full flex items-center justify-center text-sm text-zinc-500">2</span>
                Define Segments
              </h3>
              <TimelineEditor
                segments={segments}
        ...
        <div className="lg:col-span-12 xl:col-span-5 flex flex-col gap-8 sticky top-24">
          {segments.length > 0 && (
            <div className="flex flex-col gap-4">
              <h3 className="text-sm font-black uppercase tracking-[0.2em] text-zinc-400 flex items-center gap-2">
                <span className="bg-zinc-100 dark:bg-zinc-800 size-6 rounded-full flex items-center justify-center text-sm text-zinc-500">3</span>
                Process & Download
              </h3>
              <Button
                size="lg"
              ...
              {isProcessing && (
                <div className="flex flex-col gap-3 p-6 bg-white dark:bg-zinc-900 rounded-3xl border border-zinc-100 dark:border-zinc-800 shadow-xl">
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-black uppercase tracking-widest text-primary">{status}</span>
