    ...
    <header className="sticky top-0 z-50 w-full border-b border-zinc-200 dark:border-zinc-800 bg-white/80 dark:bg-black/80 backdrop-blur-md">
      <div className="container mx-auto h-16 grid grid-cols-3 items-center px-4 md:px-6">
        <div className="flex items-center gap-1">
          <img src="/logo-square.jpeg" alt="Logo" className="w-10 h-10" />
          <div className="flex flex-col">
            <Link href="#hero" className="text-xl font-black tracking-tighter text-zinc-900 dark:text-white leading-none">
              ...
              <span className="text-secondary">Clipper</span>
            </Link>
        ...
        <nav className="justify-self-center hidden md:flex items-center gap-6 font-medium text-zinc-600 dark:text-zinc-400">
          ...
          <Link href="#app" className="font-extrabold text-primary">
            App
          </Link>
        </nav>
